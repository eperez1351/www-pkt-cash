export default {
    header: {
        ...
        community: "Comunidad",
        letter: "Carta de CJD",
        origin_story: "El origen de PKT",
        cryptoeconomics: "Cryptoeconomics",
        info: "Info",
        docs: "Docs",
        blog: "Blog",
        explorer: "Explorador de Bloques",
        whitepaper: "Hoja Blanca(Whitepaper)",
        deck: "Deck",
    ...
    footer: {
        quicklink: "Quicklink",
        setup_pktcrypt: "Configura PacketCrypt",
        about: "Acerca de",
        git: "Github",
        policy: "Privacy Policy",
        join_community: "Unete a la comunidad",
        network_steward_voting: "Eleccion del Network Steward",
        origin_story: "Origen de PKT",
        trademark: "Reglas de uso de marca",
    ...
    home: {
        meta_title: "PKT Cash - La primera Blockchain del mundo centrada en el ancho de banda",
        meta_descr: "El primer protocolo de blockchain centrado de ancho de banda del mundo, creado para fomentar el crecimiento de la infraestructura de red.",
        header_heading: "La primera Blockchain del mundo centrada en el ancho de banda",
        index_1: "Ancho de banda de la red",
        index_1_metric: "Mb/s",
        index_2: "Dificultad",
        index_3: "Minado hasta el momento",
        index_4: "Encript. / Seg",
        index_5: "Recompensa por bloque actual",
        index_6: "Monedas restantes",
        adv_text_1: "El network steward es una dirección que recibe el 20% de cada nuevo block-mine para que los desarrolladores puedan financiar el desarrollo de la tecnología de la red de mallas. A diferencia de la premina o la cuota de fundador, el receptor del pago del administrador de la red puede cambiarse mediante una votación del PoS.",
        adv_text_3: "Hay varias opciones para instalar una billetera PKT. Algunos monederos son adecuados para las transacciones simples, mientras que otros están capacitados para la minería. Las billeteras actualmente soportadas incluyen una billetera de línea de comandos basada en la terminal, la billetera PKT de Electrum, y la billetera PKT Zulu GUI. También se está desarrollando un monedero móvil que estará disponible muy pronto.",
        scroll_section_title: "La Red",
        scroll_section_descr: "El primer protocolo de blockchain centrado de ancho de banda del mundo, creado para fomentar el crecimiento de la infraestructura de red.",
        scroll_section_button_label: "Mas detalles",
        ...
        scroll_section_block_5_descr: "PKT es una criptomoneda nativa basada en el código de Bitcoin, por lo que está preparada para la Red Lightning \n" +
        "desde el primer día. No es un token, por lo que no hay un emisor centralizado ni comisiones de gas. \n",
        scroll_section_block_6_descr: "PKT es una nueva cadena de bloques que recompensa a los usuarios por aportar ancho de banda a la red. \n" +
        "Los nodos emiten lo que se llama anuncios (“anns”) a través de la red, y los Blockminers recogen esos anns y los ponen en la blockchain. \n",
        features_title: "Caracteristicas",
        feature_1_title: "Centrada en el ancho de banda",
        feature_1_descr: "La asignación del ancho de banda de la red es necesaria para obtener recompensas de minería.",
        feature_2_title: "Networking",
        feature_2_descr: "Cuantos más nodos estén conectados, más rápida será la red.",
        feature_3_title: "Escalabilidad",
        feature_3_descr: "Responde a las exigencias de los operadores de redes y proveedores de infraestructuras.",
        join_community_title: "Únete a la comunidad",
        join_community_text: "PKT está dirigido por la comunidad para la comunidad. La red se vuelve más segura cuando está formada por personas como TÚ. Únete ahora a la comunidad para recibir actualizaciones y debates sobre cómo participar en esta red en crecimiento.",
        join_community_label_link: "Únete",
        roadmap_link: "Roadmap",
        subtitle: "BIENVENIDO A PKT",
        title: "Internet Por La Gente, Para La Gente",
        content_1: "PKT es el único protocolo de capa 1 diseñado para transmitir datos de alta velocidad en todo el mundo y permitir el acceso a Internet sin depender de un ISP monopolístico tradicional.",
        content_2: "PKT separa las funciones técnicas de las físicas del servicio de Internet, de modo que cualquiera puede cobrar por proporcionar Internet en su vecindario como Edge Point, o facilitar servicios técnicos en línea como ISP en la nube.",
        link_1: "¿Que es un ISP en la nube?",
        link_2: "Become an Edge Point",
        mining_data_title: "Mainnet",
        mining_data_subtitle: "Live",
        bandwidth: "Ancho de Banda de la Red",
        mined: "Minado por dia",
        encryptions: "Encriptaciones / Seg",
        pkt_price: "Precio PKT",
        block_1_title: "Crea",
        block_1_subtitle: "El futuro de la red", 
        block_1_content: "El ecosistema PKT pretende resolver el problema de la monopolización del acceso a Internet por parte de los proveedores de servicios de Internet, ofreciendo a las personas oportunidades de \"negocio instantáneo\" para apoyar y ampliar la red PKT en todo el mundo.", 
        block_1_content_last: "El 20% de cada bloque minado se paga al administrador de la red, que es una dirección de cartera elegida democráticamente que proporciona subvenciones para el desarrollo de la tecnología y la infraestructura.", 
        block_1_label_1: "Que crear", 
        block_1_label_2: "Get Funding", 
        block_1_single_1_title: "Red de Mallas", 
        block_1_single_1_descr: "La Red PKT permitirá un acceso completamente privado y seguro a Internet sin necesidad de utilizar un ISP tradicional.", 
        block_1_single_2_title: "Monetize Your Internet", 
        block_1_single_2_descr: "Ahora puede monetizar el ancho de banda de Internet que ya paga y ayudar a alimentar la Red PKT.", 
        block_1_single_3_title: "Building on cjdns", 
        block_1_single_3_descr: "PKT es la continuación del proyecto de código abierto de red de mallas cjdns, que permite a cualquiera obtener una dirección IP sin un emisor central.", 
        block_2_title: "Mine",
        block_2_subtitle: "Turn Bandwidth Into Income", 
        block_2_content: "PKT utiliza PacketCrypt, la primera prueba de trabajo del mundo que no depende del ancho de banda. Usted puede ganar PKT Cash (PKT) cuando se conecta su casa u oficina de Internet a la Red PKT.",
        block_2_content_last: "PKT utiliza dos tipos de minería: la minería de anuncios, que cualquiera puede realizar con un dispositivo basado en la CPU, y la minería de bloques, que requiere una infraestructura sólida y experiencia en redes.",
        block_2_label_1: "Comienza a minar", 
        block_2_label_2: "Descarga la billetera", 
        block_2_single_1_title: "Gana PKT", 
        block_2_single_1_descr: "PKT es una moneda minada, no un token, acuñada cada 60 segundos a partir de la conectividad persistente a Internet utilizando la prueba de trabajo PacketCrypt.", 
